...
class RandomHumanoidEnv(MujocoEnv, utils.EzPickle):
    def __init__(self, noisy=False):
        ...
        self.default_task = np.concatenate([self.original_masses, self.original_damping])
        ...
        self.least_train_step = 2000000 # at least train these many steps
    ...
    def get_random_task(self):
        ...
        task = np.concatenate([self.default_task[:13],task[13:]])
        return task
gym.envs.register(
